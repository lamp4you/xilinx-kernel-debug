...
int netdev_register_kobject(struct net_device *ndev)
{
    ...
    device_debug_msg(ndev->name, NULL, "netdev_register_kobject : net_device(%s)\n", ndev->name);
	...
	*groups++ = &netstat_group;
    ...
    device_debug_msg(dev_name(dev), NULL, "netdev_register_kobject : net_device(%s) - device_add\n", dev_name(dev));
